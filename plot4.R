...
## This R script checks if across the United States, 
...
# Merge NEI and SCC.coal datasets
...
# I am generating graph using ggplot and storing in PNG format, calling it 'plot4.png' 
